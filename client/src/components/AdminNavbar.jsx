      ...
      <div className="flex items-center justify-between gap-4 max-w-[1440px] mx-auto">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-2 rounded-xl text-slate-700 hover:text-slate-900 hover:bg-slate-200/60 focus:outline-none transition-colors"
            title="Toggle Menu"
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2.5 p-1 sm:px-2 sm:py-1 rounded-full hover:bg-slate-200/50 transition-colors text-left"
            >
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-52 bg-white rounded-2xl shadow-lg border border-slate-200/80 py-2 z-50 animate-in fade-in zoom-in-95 duration-100">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-xs text-rose-600 hover:bg-rose-50 flex items-center gap-2 transition-colors mt-1 font-medium"
                  >

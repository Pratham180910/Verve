...
import { Home, Folder, Users, CheckSquare, BarChart2, X } from 'lucide-react';

const ProjectLeadSidebar = ({ isOpen, onClose, activePage = 'Dashboard', onNavigate }) => {
  ...
  // Project Lead navigation must contain ONLY these 5 items:
  const navItems = [
      ...
      >
        ...
        <div className="px-3 pt-6">
          <p className="text-xs font-serif italic text-slate-400 leading-relaxed">
            “Lead today for a better tomorrow.”
          </p>
...
export default ProjectLeadSidebar;

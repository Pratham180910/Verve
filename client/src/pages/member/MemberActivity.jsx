...
const MemberActivity = ({ onNavigate }) => {
  ...
  const fetchActivities = async () => {
    try {
      setLoading(true);
      const res = await memberDashboardAPI.getActivities({
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 mt-1">
              Actions, task progressions, and milestones relevant to your projects.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs flex items-center gap-3.5">
            ...
            <div>
              ...
              <div className="text-xs text-slate-500 font-medium">Relevant Events</div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs flex items-center gap-3.5">
            ...
            <div>
              ...
              <div className="text-xs text-slate-500 font-medium">Task Updates</div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs flex items-center gap-3.5">
            ...
            <div>
              ...
              <div className="text-xs text-slate-500 font-medium">Participating Projects</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xs p-6 space-y-6">
          {loading ? (
            ...
            <div className="py-12 text-center text-xs text-slate-400">
              No recent activity recorded for your participating projects.
            </div>
          ) : (
